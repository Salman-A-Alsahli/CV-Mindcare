...
class SettingsDialog(ctk.CTkToplevel):
    ...
    def _create_widgets(self):
        ...
        self.backend_port_label = ctk.CTkLabel(
            backend_tab,
            text="Backend Port:",
            anchor="w"
        )
        ...
        self.auto_start_backend_check = ctk.CTkCheckBox(
            ...
            variable=self.auto_start_backend_var
        )
        ...
        self.enable_camera_check = ctk.CTkCheckBox(
            sensors_tab,
            text="Enable camera/face detection",
            variable=self.enable_camera_var
        )
        ...
        self.window_width_label = ctk.CTkLabel(
            ui_tab,
            text="Window Width:",
            anchor="w"
        )
        self.window_width_entry = ctk.CTkEntry(
            ui_tab,
            placeholder_text="700"
        )
        
        self.window_height_label = ctk.CTkLabel(
            ui_tab,
            text="Window Height:",
            anchor="w"
        )
