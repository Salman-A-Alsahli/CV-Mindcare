...
from backend.analytics import Analytics, AggregationPeriod, TrendDirection
...
class TestAnalytics:
    ...
    def sample_data(self):
        ...
        now = datetime.now()
        return [{"timestamp": now - timedelta(hours=i), "value": 20.0 + i} for i in range(10)]
    ...
    def test_get_aggregated_data_hourly(self, analytics, sample_data):
        ...
        with patch.object(analytics, "_get_raw_data", return_value=sample_data):
            result = analytics.get_aggregated_data(
                data_type="greenery", period=AggregationPeriod.HOURLY
            )
    ...
    def test_get_aggregated_data_daily(self, analytics, sample_data):
        ...
        with patch.object(analytics, "_get_raw_data", return_value=sample_data):
            result = analytics.get_aggregated_data(
                data_type="noise", period=AggregationPeriod.DAILY
            )
    ...
    def test_get_aggregated_data_weekly(self, analytics, sample_data):
        ...
        with patch.object(analytics, "_get_raw_data", return_value=sample_data):
            result = analytics.get_aggregated_data(
                data_type="greenery", period=AggregationPeriod.WEEKLY
            )
    ...
    def test_detect_trends_increasing(self, analytics):
        ...
        data = [
            {"timestamp": now - timedelta(days=10 - i), "value": 10.0 + i * 5.0} for i in range(10)
        ]
    ...
    def test_detect_trends_decreasing(self, analytics):
        ...
        data = [
            {"timestamp": now - timedelta(days=10 - i), "value": 50.0 - i * 3.0} for i in range(10)
        ]
    ...
    def test_detect_trends_stable(self, analytics):
        ...
        data = [
            {"timestamp": now - timedelta(days=i), "value": 25.0 + (i % 3) * 0.5} for i in range(10)
        ]
    ...
    def test_detect_anomalies(self, analytics):
        ...
        for i, val in enumerate(normal_values + outliers):
            data.append({"timestamp": now - timedelta(hours=i), "value": val})
    ...
    def test_detect_anomalies_no_variation(self, analytics):
        ...
        now = datetime.now()
        # All values the same
        data = [{"timestamp": now - timedelta(hours=i), "value": 25.0} for i in range(10)]
    ...
    def test_get_correlation_positive(self, analytics):
        ...
        greenery_data = [
            {"timestamp": now - timedelta(hours=i), "value": 20.0 + i * 2.0} for i in range(20)
        ]
        noise_data = [
            {"timestamp": now - timedelta(hours=i), "value": 30.0 + i * 1.5} for i in range(20)
        ]
    ...
    def test_get_correlation_negative(self, analytics):
        ...
        greenery_data = [
            {"timestamp": now - timedelta(hours=i), "value": 50.0 - i * 2.0} for i in range(20)
        ]
        noise_data = [
            {"timestamp": now - timedelta(hours=i), "value": 20.0 + i * 2.0} for i in range(20)
        ]
    ...
    def test_get_chart_data(self, analytics, sample_data):
        ...
        with patch.object(analytics, "_get_raw_data", return_value=sample_data):
            chart_data = analytics.get_chart_data(
                data_type="greenery", period=AggregationPeriod.HOURLY, days=1
            )
    ...
    def test_format_trend_message_increasing(self, analytics):
        ...
        message = analytics._format_trend_message(TrendDirection.INCREASING, 25.0, 0.85)
    ...
    def test_format_trend_message_stable(self, analytics):
        ...
        message = analytics._format_trend_message(TrendDirection.STABLE, 3.0, 0.5)
